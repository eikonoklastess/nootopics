      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="bg-white dark:bg-[#313338] text-black dark:text-white border-none shadow-xl max-w-md p-6">
          ...
          <DialogFooter className="mt-6 flex justify-between sm:justify-between items-center w-full">
            <Button onClick={() => setShowDeleteAlert(true)} variant="ghost" className="text-red-500 hover:text-red-600 hover:bg-red-500/10">
              Delete Channel
            </Button>
      ...
      <AlertDialog open={showDeleteAlert} onOpenChange={setShowDeleteAlert}>
        <AlertDialogContent className="bg-white dark:bg-[#313338] border-zinc-200 dark:border-zinc-700">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete <span className="font-semibold">#{name}</span>? This will permanently delete all messages in this channel. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
